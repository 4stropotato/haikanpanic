...
function App() {
  ...
  // v1.07+ move lens to follow snapped point
  useEffect(() => {
    if (lastSnap) {
      setLensPos(lastSnap);
    }
    ...
    <div className="app">
      <div className="top-bar">
        ...
        <div className="controls">
          ...
          <button onClick={() => setShowMagnifier(!showMagnifier)}> {/* v1.05+ */}
      ...
      >
        ...
        {showMagnifier && (
          <Magnify x={lensPos.x} y={lensPos.y} />          // v1.07+ direct compositing at crosshair
        )}
      </div>
    </div>
  );
