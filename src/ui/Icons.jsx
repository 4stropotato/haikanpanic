// [v1.14] Clean SVG icons - no emojis, professional design
...
// v1.16+ Send-to-Studio icon (pipe joint with outgoing arrow)
export const SendToStudioIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 20 L12 12 L12 4"/>
    <circle cx="12" cy="12" r="2.2" fill="currentColor" stroke="none"/>
    <path d="M15 15 L21 21"/>
    <polyline points="21 15.5 21 21 15.5 21"/>
  </svg>
);

// v1.19+ Pencil/edit icon
...
// v2.02 cube icon for Workshop 3D view
...
// v2.30 draw (line) icon — the mode you return to
export const PencilDrawIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <line x1="4" y1="20" x2="20" y2="4"/>
    <circle cx="4" cy="20" r="2.4" fill="currentColor" stroke="none"/>
